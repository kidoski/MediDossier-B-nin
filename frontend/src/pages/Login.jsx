      ...
      <div style={styles.top}>
        ...
        <div style={styles.features}>
          <div style={styles.feature}>
            ...
            <span style={styles.featureText}>Patients</span>
          </div>
          <div style={styles.feature}>
            <span style={styles.featureIcon}>📋</span>
            <span style={styles.featureText}>Consultations</span>
          </div>
          <div style={styles.feature}>
            <span style={styles.featureIcon}>🩺</span>
            <span style={styles.featureText}>Constantes</span>
          </div>
          <div style={styles.feature}>
            <span style={styles.featureIcon}>📁</span>
            <span style={styles.featureText}>Antécédents</span>
          </div>
        </div>
      </div>
